...
dependencies {
    ...
    implementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.20")
    implementation("com.symmetricalpalmtree.gpaper:gpaper-onyx:0.1.20")
    ...
    testImplementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.20")
}
