...
dependencies {
    ...
    implementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.16")
    implementation("com.symmetricalpalmtree.gpaper:gpaper-onyx:0.1.16")
    ...
    testImplementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.16")
}
