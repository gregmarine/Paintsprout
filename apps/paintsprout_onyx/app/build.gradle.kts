...
dependencies {
    ...
    implementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.14")
    implementation("com.symmetricalpalmtree.gpaper:gpaper-onyx:0.1.14")
    ...
    testImplementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.14")
}
