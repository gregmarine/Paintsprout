...
dependencies {
    ...
    implementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.24")
    implementation("com.symmetricalpalmtree.gpaper:gpaper-onyx:0.1.24")
    ...
    testImplementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.24")
}
