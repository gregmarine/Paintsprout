...
dependencies {
    ...
    implementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.25")
    implementation("com.symmetricalpalmtree.gpaper:gpaper-onyx:0.1.25")
    ...
    testImplementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.25")
}
