...
dependencies {
    ...
    implementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.15")
    implementation("com.symmetricalpalmtree.gpaper:gpaper-onyx:0.1.15")
    ...
    testImplementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.15")
}
