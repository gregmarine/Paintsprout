...
dependencies {
    ...
    implementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.11")
    implementation("com.symmetricalpalmtree.gpaper:gpaper-onyx:0.1.11")
    ...
    testImplementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.11")
}
