...
dependencies {
    ...
    implementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.18")
    implementation("com.symmetricalpalmtree.gpaper:gpaper-onyx:0.1.18")
    ...
    testImplementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.18")
}
