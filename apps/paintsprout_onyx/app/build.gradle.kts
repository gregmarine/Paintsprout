...
dependencies {
    ...
    implementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.13")
    implementation("com.symmetricalpalmtree.gpaper:gpaper-onyx:0.1.13")
    ...
    testImplementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.13")
}
