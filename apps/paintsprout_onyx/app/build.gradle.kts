...
dependencies {
    ...
    implementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.22")
    implementation("com.symmetricalpalmtree.gpaper:gpaper-onyx:0.1.22")
    ...
    testImplementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.22")
}
