...
dependencies {
    ...
    implementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.17")
    implementation("com.symmetricalpalmtree.gpaper:gpaper-onyx:0.1.17")
    ...
    testImplementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.17")
}
