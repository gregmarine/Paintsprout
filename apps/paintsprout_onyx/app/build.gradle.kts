...
dependencies {
    ...
    implementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.21")
    implementation("com.symmetricalpalmtree.gpaper:gpaper-onyx:0.1.21")
    ...
    testImplementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.21")
}
