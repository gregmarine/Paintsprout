...
dependencies {
    ...
    implementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.8")
    implementation("com.symmetricalpalmtree.gpaper:gpaper-onyx:0.1.8")
    ...
    testImplementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.8")
}
