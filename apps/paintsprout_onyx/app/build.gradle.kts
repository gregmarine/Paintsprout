...
dependencies {
    ...
    //
    // Pinned at 0.1.31 — the rubbing eraser (Phase 18) on top of the raster undo (Phase 17): `readPageRaster` hands out the
    ...
    // never arms.
    implementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.31")
    implementation("com.symmetricalpalmtree.gpaper:gpaper-onyx:0.1.31")
    ...
    testImplementation("com.symmetricalpalmtree.gpaper:gpaper-core:0.1.31")
}
